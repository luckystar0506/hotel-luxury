    ...
    <>
      <nav className="nav-menu">
        ...
        <ul>
          ...
          {page==='contact_us'?(<li className="list-style list-style::after"><a className="a-text-style" href="#">Contact</a></li>):(<li className="nav-manu-ul-li"><a href="/contact_us">Contact</a></li>)}
        </ul>
      </nav>
    </>
  )
